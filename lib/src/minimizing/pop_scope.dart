...
class ZegoUIKitPrebuiltLiveAudioRoomMiniPopScope extends StatefulWidget {
  ...
  @override
  ZegoUIKitPrebuiltLiveAudioRoomMiniPopScopeState createState() =>
      ZegoUIKitPrebuiltLiveAudioRoomMiniPopScopeState();
}

/// @nodoc
class ZegoUIKitPrebuiltLiveAudioRoomMiniPopScopeState
    extends State<ZegoUIKitPrebuiltLiveAudioRoomMiniPopScope> {
  @override

...
```dart
dependencies:
  zego_uikit_prebuilt_live_audio_room: ^1.0.3 # Add this line
```
...
<div class="md-grid-list-box">
  <a href="https://github.com/ZEGOCLOUD/zego_uikit_prebuilt_live_audio_room_example_flutter" class="md-grid-item" target="_blank">
